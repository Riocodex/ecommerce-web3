...
contract ShoppingCart{
   ...
   struct customerDetails{
    ...
    customerDetails[] public allCustomers;
    ...
    function postAnItem(string memory _name, uint256 _price)public checkOwner() returns(itemDetails[] memory){
